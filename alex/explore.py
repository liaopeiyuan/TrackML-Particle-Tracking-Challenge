...
def run_explore():
    ...
    for event in events:
        ...
        particles = pd.read_csv(data_dir + '/train/event%s-particles.csv'%event)
        ...
        #print(truth)
        h = truth.loc[
              (truth.volume_id.isin([8,])) & (truth.layer_id.isin([2,4,6,]))  & ( ((truth.module_id<400) & (truth.module_id>365)) | ((truth.module_id<115) & (truth.module_id>90)) | ((truth.module_id<220) & (truth.module_id>190)) )    
        ]
        ...
        ax.set_ylim(-100,100), ax.set_ylabel('y', fontsize=16)
    ...
    save_pickle_file('/home/alexanderliao/data/GitHub/Kaggle-TrackML/triplenet/data/samples_train.pickle', samples[:-2])
    save_pickle_file('/home/alexanderliao/data/GitHub/Kaggle-TrackML/triplenet/data/samples_valid.pickle', samples[-2:])
    zz=0
