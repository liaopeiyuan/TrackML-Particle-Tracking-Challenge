...
class TrackMLDataset(Dataset):
    def __init__(self, split, transform=None, mode='train',size=50):
        super(TrackMLDataset,self).__init__()
        self.transform=transforms
        self.mode=mode
        self.split=split
        self.path='/home/alexanderliao/data/Kaggle/competitions/trackml-particle-identification/train_triplet'
        self.size=size
...
class DummyDataset(Dataset):
    ...
    def __init__(self, split, transform=None, mode='train'):
        ...
        self.samples = load_pickle_file(
            '/home/alexanderliao/data/GitHub/Kaggle-TrackML/triplenet/data/%s.pickle'%split
        )
