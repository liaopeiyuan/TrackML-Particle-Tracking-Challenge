...
class TestUfunc(object):
    ...
    def test_object_logical(self):
        ...
        assert_equal(np.logical_or(a, "final-atom"),
                        np.array([x or "final-atom" for x in a], dtype=object))
        ...
        assert_equal(np.logical_and(a, "final-atom"),
                        np.array([x and "final-atom" for x in a], dtype=object))
