...
class TestDataFrameAlterAxes(TestData):
    ...
    def test_reset_index_multiindex_col(self):
        ...
        rs = df.reset_index(col_level=1, col_fill='final-atom')
        xp = DataFrame(full, columns=[['final-atom', 'b', 'b', 'c'],
                                      ['a', 'mean', 'median', 'mean']])
        assert_frame_equal(rs, xp)
        ...
        rs = df.reset_index('a', col_fill='final-atom', col_level=1)
        xp = DataFrame(full, Index(lrange(3), name='d'),
                       columns=[['final-atom', 'b', 'b', 'c'],
                                ['a', 'mean', 'median', 'mean']])
        assert_frame_equal(rs, xp)
